...
public abstract class EntityCreature extends EntityHooks {
    ...
    protected void updateEntityActionState() {
        ...
        if(this.entityToAttack == null) {
        	//override
            this.entityToAttack = tryFindPlayer();
            ...
            if(this.canEntityBeSeen(this.entityToAttack)) {
            	//override
                this.tryAttackEntity(this.entityToAttack, var2);
            } else {
        ...
        if(!this.hasAttacked && this.entityToAttack != null && (this.pathToEntity == null/* || this.rand.nextInt(20) == 0*/)) {
        	//override
            /*this.pathToEntity = */PFQueue.getPath(this, this.entityToAttack,var1);//this.worldObj.getPathToEntity(this, this.entityToAttack, var1);
