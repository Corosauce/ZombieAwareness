...
public class RenderScent extends Render {
    ...
    public void doRenderNode(Entity var1, double var2, double var4, double var6, float var8, float var9) {
        ...
        if (((EntityScent)var1).type == 1) {
            //renderImage(var1, var2, var4, var6, var8, var9, "/misc/shadow.png");
        } else {
            renderImage(var1, var2, var4, var6, var8, var9, "/misc/blood.png");
        }
    ...
    public void doRender(Entity var1, double var2, double var4, double var6, float var8, float var9) {
        ...
        shadowSize = 0.0F;
        //renderOffsetAABB(var1.boundingBox, var2 - var1.lastTickPosX, var4 - var1.lastTickPosY, var6 - var1.lastTickPosZ, ((EntityScent)var1).isUsed);
        GL11.glPopMatrix();
    }
    ...
    public static void renderOffsetAABB(AxisAlignedBB var0, double var1, double var3, double var5, boolean var7) {
        ...
        var8.setTranslationD(var1, var3, var5);
